    ...
    <div className=" w-screen">
        ...
        <div className="flex laptop:w-4/5 ipad:w-full flex-col mobile:flex-row mobile:items-center mobile:justify-center mobile:w-[80%] mobile:mb-5">
              ...
              <div className="mx-auto">
                <div className='flex mobile:flex-col items-center mobile:items-start mobile: ml-2'>
                  <OrangeBtn content="Use" classes="relative laptop:text-4xl laptop:px-[70px] laptop:mt-10 laptop:mr-12 ipad:text-3xl ipad:px-[38px] ipad:mt-4 ipad:mr-10 mobile:text-2xl mobile:top-[40px] mobile:px-6 mobile:px-[30px] custom-sm:text-lg" />
                  <OrangeBtn content="Dump" classes="relative laptop:text-4xl laptop:px-[50px] laptop:mt-10  ipad:px-[22px] ipad:text-3xl ipad:mt-4 mobile:text-2xl mobile:top-[40px] mobile:mt-[20px] mobile:px-3 mobile:px-[17px] custom-sm:text-lg"/>
                </div>
              </div>
            </div>
          <div className="relative custom-xm:top-4 flex flex-col w-full items-center justify-center">
              ...
              <div className="flex w-[95%] mt-10 mobile:justify-center">
                <div className="flex items-center w-[95%] laptop:w-[80%] mobile:w-[80%]">
                  ...
                  <div className="mr-[2vw] w-1/5 custom-sm:w-1/4">
                      <Link href="/inventory/props">
                        <div className={`flex items-center justify-center ${pathname == '/inventory/props' ? 'bg-purpleBack border-2 border-black rounded-xl min-w-[full] max-w-[full]': ''}`}>
